	...
	public void renderCompass(GuiGraphics graphics, float delta) {
		...
		for (int i = 0; i < amount; i++) {
			...
			if (indicator == Indicator.CARDINAL) {
				...
				RenderUtil.drawRectangle(graphics, innerX, y, 1, 9, majorIndicatorColor.get().withAlpha(
				...
				// We have to call .color() here so that transparency stays
				RenderUtil.drawRectangle(graphics, innerX, y, 1, 5, minorIndicatorColor.get().withAlpha(
