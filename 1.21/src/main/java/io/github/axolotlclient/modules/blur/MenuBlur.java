...
public class MenuBlur extends AbstractModule {
	...
	private final Identifier shaderLocation = Identifier.parse("minecraft:shaders/post/menu_blur.json");
	...
	public void renderBlur() {
		shader.render(MinecraftClient.getInstance().method_60646().getLastDuration());
	}
