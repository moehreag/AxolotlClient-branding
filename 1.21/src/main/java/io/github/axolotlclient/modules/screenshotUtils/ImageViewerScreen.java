...
public class ImageViewerScreen extends Screen {
	...
	private static final Identifier downloadIcon = Identifier.of("axolotlclient", "textures/gui/sprites/go.png");
	...
	private Identifier downloadImage(String url) {
		...
		try {
			...
			if (image != null) {
				Identifier id = Identifier.of("axolotlclient", "screenshot_share_" + Hashing.sha256().hashUnencodedChars(url));
