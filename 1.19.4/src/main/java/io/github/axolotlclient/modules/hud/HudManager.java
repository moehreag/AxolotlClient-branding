...
public class HudManager extends AbstractModule {
	...
	private HudManager() {
		...
		KeyBinds.getInstance().registerWithSimpleAction(new KeyBind("key.openHud", InputUtil.KEY_RIGHT_SHIFT_CODE,
			"category.axolotlclient"), () -> client.setScreen(new HudEditScreen()));
	}
